...
def test_runtime_openglviz_glfw() :
    ...
    runtime = loco.sim.Runtime( loco.sim.PHYSICS_NONE, loco.sim.RENDERING_GLVIZ_GLFW )
    ...
    visualizer.Update()
    visualizer.Reset()
    assert ( visualizer.backendId == "openglviz_glfw" )
...
if __name__ == '__main__' :
    _ = input( 'Press ENTER to start test : test_runtime_openglviz_glfw' )
    test_runtime_openglviz_glfw()
