...
TEST( TestLocoRuntimeOpenGLViz, TestRuntimeOpenGLVizGLFW )
{
    ...
    auto runtime = std::make_unique<loco::TRuntime>( loco::config::physics::NONE,
    ...
    EXPECT_EQ( simulationRef->backendId(), "null" );
    ...
    visualizerRef->Reset();
    EXPECT_EQ( visualizerRef->backendId(), "openglviz_glfw" );
