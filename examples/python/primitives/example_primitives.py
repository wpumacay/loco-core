...
if __name__ == '__main__' :
    ...
    _boxy = createSingleBody( 'boxy', 'box' )
    _scenario.addSingleBody( _boxy )
    ...
    _runtime = pytysoc.createRuntime( physicsBackend = "",
    ...
    while _visualizer.isActive() :
        ...
        if _visualizer.checkSingleKeyPress( tysoc.KEY_ESCAPE ) :
            break
