...
int main( int argc, char* argv[] )
{
    ...
    auto box = scenario->AddSingleBody( std::make_unique<loco::TBox>( "box", loco::TVec3( 0.2f, 0.3f, 0.4f ), pos_box, loco::TMat3() ) );
    auto sphere = scenario->AddSingleBody( std::make_unique<loco::TSphere>( "sphere", 0.1f, pos_sphere, loco::TMat3() ) );
    auto cylinder = scenario->AddSingleBody( std::make_unique<loco::TCylinder>( "cylinder", 0.2f, 0.5f, pos_cylinder, loco::TMat3() ) );
    auto capsule = scenario->AddSingleBody( std::make_unique<loco::TCapsule>( "capsule", 0.2f, 0.5f, pos_capsule, loco::TMat3() ) );
    auto ellipsoid = scenario->AddSingleBody( std::make_unique<loco::TEllipsoid>( "ellipsoid", loco::TVec3( 0.2f, 0.3f, 0.4f ), pos_ellipsoid, loco::TMat3() ) );
    auto mesh = scenario->AddSingleBody( std::make_unique<loco::TMesh>( "monkey",
                                                                        loco::PATH_RESOURCES + "meshes/monkey.stl",
                                                                        loco::PATH_RESOURCES + "meshes/monkey.obj",
                                                                        0.2f, pos_mesh, loco::TMat3() ) );

    auto user_sphere = scenario->AddSingleBody( std::make_unique<loco::TSphere>( "user_sphere", 0.1f, loco::TVec3( 0.0f, 0.0f, 0.1f ), loco::TMat3() ) );
    ...
    while ( visualizer->IsActive() )
    {
        ...
        else
        {
            if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_1 ) )
                static_cast<loco::TBox*>( box )->SetWidth( static_cast<loco::TBox*>( box )->width() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_2 ) )
                static_cast<loco::TBox*>( box )->SetDepth( static_cast<loco::TBox*>( box )->depth() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_3 ) )
                static_cast<loco::TBox*>( box )->SetHeight( static_cast<loco::TBox*>( box )->height() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_4 ) )
                static_cast<loco::TSphere*>( sphere )->SetRadius( static_cast<loco::TSphere*>( sphere )->radius() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_5 ) )
                static_cast<loco::TCylinder*>( cylinder )->SetRadius( static_cast<loco::TCylinder*>( cylinder )->radius() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_6 ) )
                static_cast<loco::TCylinder*>( cylinder )->SetHeight( static_cast<loco::TCylinder*>( cylinder )->height() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_7 ) )
                static_cast<loco::TCapsule*>( capsule )->SetRadius( static_cast<loco::TCapsule*>( capsule )->radius() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_8 ) )
                static_cast<loco::TCapsule*>( capsule )->SetHeight( static_cast<loco::TCapsule*>( capsule )->height() + ( increasing ? 0.1f : -0.1f ) );
            else if ( visualizer->CheckSingleKeyPress( loco::Keys::KEY_9 ) )
                static_cast<loco::TMesh*>( mesh )->SetScale( static_cast<loco::TMesh*>( mesh )->scale() + ( increasing ? 0.01f : -0.01f ) );
        }
