...
int main( int argc, char* argv[] )
{
    ...
    auto floor = scenario->AddSingleBody( std::make_unique<loco::primitives::TTriMesh>( "floor",
                                                                                        loco::PATH_RESOURCES + "meshes/mountain/mountain.obj",
                                                                                        loco::PATH_RESOURCES + "meshes/mountain/mountain.obj",
                                                                                        1.0f, loco::TVec3(), tinymath::rotationX<float>( loco::PI / 2.0f ) ) );
    floor->drawable()->ChangeColor( { 0.3f, 0.5f, 0.7f } );

    auto sphere = scenario->AddSingleBody( std::make_unique<loco::primitives::TSphere>( "sphere", 0.1f, loco::TVec3( 0.0, 0.0, 3.0 ), loco::TMat3() ) );
