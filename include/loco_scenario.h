...
namespace loco
{
    ...
    public :
        ...
        terrain::TITerrainGenerator* GeTITerrainGeneratorByName( const std::string& name );
        ...
        const terrain::TITerrainGenerator* GeTITerrainGeneratorByName( const std::string& name ) const;
        ...
        std::vector<terrain::TITerrainGenerator*> GeTITerrainGeneratorsList();
        ...
        std::vector<const terrain::TITerrainGenerator*> GeTITerrainGeneratorsList() const;
        ...
        const terrain::TITerrainGenerator* get_terrainGenerator( ssize_t index ) const;
    ...
    private :
        ...
        std::map<std::string, ssize_t> m_TerrainGeneratorsMap;
    };
}