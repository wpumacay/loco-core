...
namespace pytysoc
{
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setCollision() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setVisual() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setPosition() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setRotation() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setEuler() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setQuaternion() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::setTransform() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::pos() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::rot() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::quat() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::euler() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::tf() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::pos0() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::rot0() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::quat0() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::euler0() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::tf0() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::name() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::classType() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::dyntype() >>> wrapper contains null reference to a body" );
    ...
    {
        LOCO_CORE_ASSERT( m_bodyRef, "PyBody::data() >>> wrapper contains null reference to a body" );
