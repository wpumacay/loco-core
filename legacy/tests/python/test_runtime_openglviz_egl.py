...
def test_runtime_openglviz_egl() :
    ...
    runtime = loco.sim.Runtime( loco.sim.PHYSICS_NONE, loco.sim.RENDERING_GLVIZ_EGL )
    ...
    visualizer.Update()
    visualizer.Reset()
    assert ( visualizer.backendId == "openglviz_egl" )
...
if __name__ == '__main__' :
    _ = input( 'Press ENTER to start test : test_runtime_openglviz_egl' )
    test_runtime_openglviz_egl()
