...
def test_runtime_null_objs() :
    ...
    runtime = loco.sim.Runtime( loco.sim.PHYSICS_NONE, loco.sim.RENDERING_NONE )
...
if __name__ == '__main__' :
    _ = input( 'Press ENTER to start test : test_runtime_null_objs' )
    test_runtime_null_objs()
