...
int main( int argc, char* argv[] )
{
    ...
    scenario->AddSingleBody( std::make_unique<loco::primitives::TConvexMesh>( "tetrahedron_0",
                                                            TETRAHEDRON_VERTICES,
                                                            TETRAHEDRON_FACES,
                                                            1.0f, loco::TVec3( -1.0f, -1.0f, 1.0f ), rotation ) );
    scenario->AddSingleBody( std::make_unique<loco::primitives::TConvexMesh>( "tetrahedron_1",
                                                            TETRAHEDRON_VERTICES,
                                                            TETRAHEDRON_FACES,
                                                            0.5f, loco::TVec3( -1.0f, 1.0f, 1.0f ), rotation ) );
    scenario->AddSingleBody( std::make_unique<loco::primitives::TConvexMesh>( "ramp_0",
                                                            RAMP_VERTICES,
                                                            RAMP_FACES,
                                                            0.3f, loco::TVec3( 1.0f, 1.0f, 1.0f ), rotation ) );
    scenario->AddSingleBody( std::make_unique<loco::primitives::TConvexMesh>( "ramp_1",
                                                            RAMP_VERTICES,
                                                            RAMP_FACES,
                                                            0.5f, loco::TVec3( 1.0f, -1.0f, 1.0f ), rotation ) );
    for ( ssize_t i = 0; i < 12; i++ )
    {
        ...
        scenario->AddSingleBody( std::make_unique<loco::primitives::TConvexMesh>( "path_part_" + std::to_string( i ),
                                                                vertex_data.first,
                                                                vertex_data.second,
