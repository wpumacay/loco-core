...
namespace rlsim {
    ...
    void RlsimVisual::collectAttribs( const nlohmann::json& jsonElement )
    {
    ...
    void RlsimBody::collectAttribs( const nlohmann::json& jsonElement )
    {
        this->name  = tysoc::json::safeParseString( jsonElement, "Name", "undefined" );
        this->shape = tysoc::json::safeParseString( jsonElement, "Shape", "box" );
    ...
    void RlsimJoint::collectAttribs( const nlohmann::json& jsonElement )
    {
        this->name = tysoc::json::safeParseString( jsonElement, "Name", "undefined" );
