...
namespace terrain {
    ...
    TPerlin1DProfileGenerator::TPerlin1DProfileGenerator()
        : TPerlin1DProfileGenerator( 4, 0.5f, 2.0f, 10.0f )
    {

    }

    float TPerlin1DProfileGenerator::generate( float x )
    {
        ...
        return 2.0f * _noiseHeight;
    }

    float TPerlin1DProfileGenerator::_perlin2d( float x, float y )
    {
    ...
    float TPerlin1DProfileGenerator::_lerp( float a, float b, float t )
    {
        return ( 1 - t ) * a + t * b;
    }

    float TPerlin1DProfileGenerator::_fade( float t )
    {
        return t * t * t * ( t * ( t * 6 - 15 ) + 10 );
    }

    float TPerlin1DProfileGenerator::_dotgrad( int hash, float xf, float yf )
    {
